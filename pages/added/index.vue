<template class="template_body">
	<view class="bg">
		...
		<image src="http://www.fangpaiwang.com/client_entrustment_top.png" class="bgImg"></image>
		<!-- <text class="desc">程序猿小哥哥正在开发~</text> -->
		<view class="template_form">
			<image src="http://www.fangpaiwang.com/client_entrustment_middle.png" class="client_entrustment_middle"></image>
			...
			<image src="http://www.fangpaiwang.com/client_entrustment_tail.png" class="tailImg"></image>
		</view>
	...
	export default {
		...
		methods: {
			getButton() {
				...
				this.fun.getReq(this.baseUrl + '/api/attract_customers', {
						mobile: this.template_form_phone_click,
						user_name: this.template_form_name_click,
						source: 3
					})
					.then((res) => {
						console.log(res)
