...
<script>
	export default{
		props:{
			...
			abImg:{
				type: String,
				default: 'https://www.fangpaiwang.com/uploads/poster/20200826/d49400d4e138579c912e2e2b8265052a.jpg'
			}
		},
		data(){
			return {
				...
				isShow: false,
				headerImg:'',
				qrcode: 'https://www.fangpaiwang.com/uploads/poster/20200826/d49400d4e138579c912e2e2b8265052a.jpg'
			}
		},
		methods:{
			//显示
			...
			async __init(){
				...
				this.ctx.setFillStyle('#858585');
				this.ctx.fillText('长按识别图中“房拍网”小程序',30,(((this.canvasW-hW) / 2) + hH + 150))
				//底部广告
